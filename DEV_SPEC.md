...
|---------|---------|------|---------|------|
| A1 | 初始化目录树与最小可运行入口 | [x] | 2026/05/07 | |
| A2 | 引入 pytest 并建立测试目录约定 | [x] | 2026/05/07 | |
| A3 | 配置加载与校验（Settings） | [x] | 2026/05/07 | |

#### 阶段 B：Libs 可插拔层

| 任务编号 | 任务名称 | 状态 | 完成日期 | 备注 |
|---------|---------|------|---------|------|
| B1 | LLM 抽象接口与工厂 | [x] | 2026/05/07 | |
| B2 | Embedding 抽象接口与工厂 | [x] | 2026/05/07 | |
| B3 | Splitter 抽象接口与工厂 | [x] | 2026/05/07 | |
| B4 | VectorStore 抽象接口与工厂 | [x] | 2026/05/07 | |
| B5 | Reranker 抽象接口与工厂（含 None 回退） | [x] | 2026/05/07 | |
| B6 | Evaluator 抽象接口与工厂 | [x] | 2026/05/07 | |
| B7.1 | OpenAI-Compatible LLM 实现 | [x] | 2026/05/08 | |
| B7.2 | Ollama LLM 实现 | [x] | 2026/05/08 | |
| B7.3 | OpenAI & Azure Embedding 实现 | [x] | 2026/05/08 | |
| B7.4 | Ollama Embedding 实现 | [x] | 2026/05/08 | |
| B7.5 | Recursive Splitter 默认实现 | [x] | 2026/05/08 | |
| B7.6 | ChromaStore 默认实现 | [x] | 2026/05/08 | |
| B7.7 | LLM Reranker 实现 | [x] | 2026/05/08 | |
| B7.8 | Cross-Encoder Reranker 实现 | [x] | 2026/05/08 | |
| B8 | Vision LLM 抽象接口与工厂集成 | [x] | 2026/05/08 | |
| B9 | Azure Vision LLM 实现 | [x] | 2026/05/08 | |
...
| C10 | BatchProcessor | [x] | 2026/05/09 | 15 tests passed |
...
| 任务编号 | 任务名称 | 状态 | 完成日期 | 备注 |
|---------|---------|------|---------|------|
| G1 | Dashboard 基础架构与系统总览页 | [x] | 2026/05/09 | Streamlit多页面应用，系统配置展示 |
| G2 | DocumentManager 实现 | [x] | 2026/05/09 | 11个测试通过，跨存储文档管理 |
| G3 | 数据浏览器页面 | [x] | 2026/05/09 | |
| G4 | Ingestion 管理页面 | [x] | 2026/05/09 | |
| G5 | Ingestion 追踪页面 | [x] | 2026/05/09 | 14个测试通过 |
| G6 | Query 追踪页面 | [x] | 2026/05/09 | |
...
| H5 | Recall 回归测试（E2E） | [x] | 2026/05/10 | 12个测试通过 |
...
### [x] C7：ImageCaptioner（可选生成 caption + 降级不阻塞）
